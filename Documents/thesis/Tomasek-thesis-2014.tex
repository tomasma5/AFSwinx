...
%\resizebox{\textwidth}{\textheight}
 %{\includegraphics{images/zadani.png}}\hspace*{-\textwidth}
\includepdf[page=1]{images/zadani.pdf}
...
\begin{figure}
\includegraphics{images/AbsenceManagementAdmin}
\caption{Ukázkový projekt - správa absencí z pohledu administrátora}
...
\begin{lstlisting}[caption=Ukázka definice komponenty,
  label={code:xmlCompleteDefinition}, basicstyle=\footnotesize]
