...
import cz.cvut.fel.matyapav.afandroid.rest.HeaderType;
import cz.cvut.fel.matyapav.afandroid.rest.HttpMethod;
import cz.cvut.fel.matyapav.afandroid.rest.SecurityMethod;
                    ...
                    for (int k = 0; k < nodeProperties.getLength(); k++) {
                        ...
                        if (nodeName.equals(END_POINT)) {
                            ...
                            HttpMethod httpMethod =
                                    (HttpMethod) Utils.getEnumFromString(HttpMethod.class,
