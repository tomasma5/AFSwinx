...
public class BaseScreen extends JFrame{
    ...
    protected JPanel createLocalizationToolbar(){
        ...
        JButton czech = new JButton(new ImageIcon(this.getClass().getResource("/images/czech.png")));
        czech.setBorder(BorderFactory.createEmptyBorder());
        czech.setContentAreaFilled(false);
        czech.addActionListener(onCzechButtonExec);
        JButton english = new JButton(new ImageIcon(this.getClass().getResource("/images/english.png")));
